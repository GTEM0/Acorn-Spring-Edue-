...
import com.acorn.day4.naver.ItemDTO;

@Component
public class ApiExplorer4 {
	public static void main(String[] args) throws IOException {
		ApiExplorer4 at = new ApiExplorer4();
		String result = at.apitest();
		
		ArrayList<ApiDTO2> list = at.apifilter(result);
		System.out.println(result);
	}

	public ArrayList<ApiDTO2> apifilter(String result) {
		...
		ArrayList<ApiDTO2> list = new ArrayList<>();
