...
import org.springframework.stereotype.Component;
	...
	public class ApiExplorer2 {
	    public static void main(String[] args) throws IOException {
	    	ApiExplorer2 at = new ApiExplorer2();
	    ...
	    public String apitest() throws IOException {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=a6ZS4bubA4FzWu2Ga7k6sG8sUBb25I5Tz6Nehx5VaImdY1aoTRissBNI5AW01ZwRl4BcsWIuobB2KEPMtaNsSw%3D%3D"); /*Service Key*/
